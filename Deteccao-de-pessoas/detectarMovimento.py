...
while cap.isOpened():
    ...
    #binarizacao
    T = mahotas.thresholding.otsu(frameDelta)
    thresh = frameDelta.copy()
    thresh[thresh > T] = 255
    thresh[thresh < 255] = 0
    ...
    cv2.imshow("Frame Inicial", firstFrame)
    cv2.imshow("Frame atual", frame)
    cv2.imshow("Frames apos processamento", temp)
